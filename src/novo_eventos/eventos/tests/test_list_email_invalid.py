...
class TestListEmailInvalid(unittest.TestCase):
    def setUp(self):
    ...
    def test_list_email_invalid(self):
        ...
        driver.find_element_by_id("id_nome").send_keys("Cecilia")
        driver.find_element_by_id("id_mensagem").clear()
        driver.find_element_by_id("id_mensagem").send_keys(u"Olá")
        driver.find_element_by_css_selector("button.btn.btn-primary").click()
        try: self.assertEqual(u"Este campo é obrigatório.", driver.find_element_by_css_selector("p.bg-danger").text)
